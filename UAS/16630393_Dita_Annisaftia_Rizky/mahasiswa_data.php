  ...
  <div class="left">
    <form class="form-inline" method="get">
      <select name="filter" class="form-control" onchange="form.submit()">
        ...
        <option value="Outsourcing"> <?php if ($filter == ''){echo "selected";}?>></option>
      </select>
    </form>
  </div>
  <div class="right">
      ...
      if(mysqli_num_rows($sql) == 0){
        ...
        ?>
          <tr>
            ...
            <td><a href="mhs_detail.php?npm=<?php echo $row['npm']; ?>">
        ...
        <td>
          ...
          <a href="mahasiswa_data.php?aksi=delete&npm=<?php echo $row['npm']; ?>" title="Hapus Data"
