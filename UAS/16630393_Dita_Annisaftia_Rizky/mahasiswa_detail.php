<?php include "head.php"; ?>
			...
			<a href="mahasiswa_data.php" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-refresh" aria-hidden=
			"true"></span>Kembali</a>
			<a href="mahasiswa_edit.php?npm=<?php echo $row['npm']; ?>" class="btn btn-sm btn-success"><span class="glyphicon 
			glyphicon-edit" aria-hidden="true"></span>Edit Data</a>
			<a href="mahasiswa_add.php?aksi=delete&npm=<?php echo $row['npm']; ?>" class="btn btn-sm btn-danger" onclick="return 
