...
<div class="container">
        <div class="col-sm-12">
            ...
            <div class="satu">
               <?php
                $sql = "select * from berita where kategori='linux' limit 5";
                $exe = mysql_query($sql);
                ...
                <a href="linux_read.php?id=<?php echo $list[0]; ?>">... Baca Selengkapnya</a></td></div>
                <hr>
             <?php }?>
            </div>
            </div>
            ...
            <h3>Artikel Utama</h3><br>
                ...
                <br>    
                 <?php
                $sql = "select * from berita where kategori='linux' order by rand() limit 10";
                $exe = mysql_query($sql);
                while($list = mysql_fetch_array($exe)) {
                ?>
                <tbody>
