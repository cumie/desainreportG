...
<form id="berita_tambah" name="berita_tambah" method="post" action="windows_insert.php" onsubmit="return simpan(event) >
...
<hr style="color: #C4DAE8; width: 90%;"/>
		<center>
		    ...
		    <button type="reset" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-repeat"></span> Ulang</button>
                    <a href="../admin/windows_admin.php"><button type="button" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-remove"></span> Batal</button></a>
		</center>
		<hr style="color: #C4DAE8; width: 90%;"/>
</form>
