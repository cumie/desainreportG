			...
			if(isset ($_POST['add'])){
				...
				if(mysqli_num_rows($cek) == 0){
						...
						if($insert){
							...
							data-dismiss="slert" aria-hidden="true">&times;</button>Data Karyawan Berhasil Di Simpan.</div>';
						}else{
							echo '<div class"alert alert-danger alert-dismissable"><button type="button" class="close"
							data-dismiss="slert" aria-hidden="true">&times;</button>ups, Data Karyawan Gagal Di Simpan.</div>';
						}
						}else{
							echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close"
