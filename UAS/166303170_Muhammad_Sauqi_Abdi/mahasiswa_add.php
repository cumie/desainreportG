<?php include "head.php"; ?>
    ...
    <?php
		if (isset($_POST['add'])){
			...
			$insert = mysqli_query($koneksi, "INSERT INTO mahasiswa(npm,nama,tempat_lahir,tanggal_lahir,no_telepon,fakultas,semester) VALUES ('$npm','$nama','$tempat_lahir','$tanggal_lahir','$no_telepon','$fakultas','$semester')") or die(mysql_error($koneksi));
				if ($insert){
