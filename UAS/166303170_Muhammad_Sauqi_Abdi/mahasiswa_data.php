...
$page_sql="SELECT * FROM mahasiswa";
if (isset($_POST['qcari'])){
	$qcari=$_POST['qcari'];
	$page_sql="SELECT * FROM mahasiswa WHERE npm like '%qcari%' or nama like '%qcari%' or no_telepon like '%qcari%' or tempat_lahir like '%qcari%' ";
	}
?>
