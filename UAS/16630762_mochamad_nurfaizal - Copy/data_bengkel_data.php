                ...
                if(mysqli_num_rows($sql) == 0 ){
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td><a href="id_detail.php?id=<?php echo $row['id']; ?>"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> <?php echo $row['nama_sparepart']; ?></a></td>
                    ...
                    <?php } ?>
                      ...
                      <td>
                        ...
                        <a href="data_bengkel_detail.php?id=<?php echo $row['id']; ?>" title="data_bengkel_detail" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

                        <a href="data_bengkel_data.php?aksi=delete&id=<?php echo $row['id']; ?>" title="Hapus Data" onclick="return confirm('Anda Yakin Akan Menghapus Data <?php echo $row['nama']; ?>?')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                      </td>
                    </tr>
                  <?php
                $no++;
