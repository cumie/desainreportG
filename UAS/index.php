<?php include "head.php"; ?>
	...
	<div class="col-sm-9">
		<p><center>
			...
			<p><center><h1> DUNIA IT </h1>

		<hr/>
		
		<div class="well"> 
			<marquee> <img face = "comic sans ms" Color = "Blue" Font Size = "24"> </marquee>
			<hr/>
			<img class="img" src="img/Prg.png"  width="80%">
			...
			<img class="img" src="img/Bola.jpg"  width="80%">
