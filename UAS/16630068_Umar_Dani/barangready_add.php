<?php include "head.php"; ?>
            ...
            if (isset($_POST['add'])){
                  ...
                  if(mysqli_num_rows($cek) == 0){
                          ...
                          $insert = mysqli_query($koneksi, "INSERT INTO karyawan(nik, nama, tempat_lahir, tanggal_lahir,no_telpon, jabatan, status)
                                                      VALUES('$nik','$nama', '$tempat_lahir','$tanggal_lahir', '$no_telpon','$jabatan','$status')") or die(mysqli_error($koneksi));
                    if($insert){
