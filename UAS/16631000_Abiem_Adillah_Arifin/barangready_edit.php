        ...
        <?php
          ...
          if(mysqli_num_rows($sql) == 0){
              ...
              if(isset($_POST['save'])){
                    ...
                    $update = mysqli_query($koneksi, "UPDATE ready SET namabarang='$namabarang', jumlah='$jumlah', harga='$harga' WHERE kode='$kode'") or die(mysqli_error());
                    if($update){
                    ...
                    <form class="form-horizontal" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="namabarang" value="<?php echo $row ['namabarang'];?>" class="form-control" placeholder="namabarang" required>
                        </div>
                      </div>
                      <div class="form-group">
