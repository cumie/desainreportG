...
if (isset($_POST['qcari'])){
  $qcari=$_POST['qcari'];
  $pageSql=" SELECT * FROM karyawan WHERE nik like '%$qcari%' or nama like '%$qcari%' or no_telepon like '%$qcari%' or
  ...
  <div class="table-responsive">
    <table class="table table-striped table-hover">
      ...
      if($filter){
        ...
        $sql = mysqli_query($koneksi, "SELECT * FROM karyawan WHERE status='$filter' ORDER BY nik
        ASC");
      }else{
