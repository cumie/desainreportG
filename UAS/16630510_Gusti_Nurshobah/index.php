<?php include "head.php"; ?>
	...
	<div class="col-sm-9">
		...
		<div class="sidebar">
			...
			<h2> Universitas Islam Kalimantan MAB </h2>
			<hr/>
			<div class="well">
			<img class="img" src="img/slide1.jpg" width="80%">
			<p> Universitas Islam Kalimantan (UNISKA) lahir atas gagasan para tokoh-tokoh agama dan tuntutan masyarakat Kalimantan akan adanya perguruan tinggi yang bernafaskan Islam dan melahirkan intelektual muslim.
				...
				<p><center>&copy; By Gusti Shobah </center></p>
			</div>	
		</div>	
